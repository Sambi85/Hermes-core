...
message1 = Message.create(user: user1, conversation: conversation1, body: "test message", recipients: [user2], sender_id: user1.id)

# Message Model - Conversation with 2 Users
message2 = Message.create(user: user1, conversation: conversation2, body: "test message", recipients: [user3], sender_id: user1.id)
message3 = Message.create(user: user2, conversation: conversation2, body: "test message", recipients: [user1], sender_id: user2.id)

# Message Model - Conversation with 3 Users
message3 = Message.create(user: user2, conversation: conversation3, body: "test message", recipients: [user1], sender_id: user2.id)
message4 = Message.create(user: user1, conversation: conversation3, body: "test message", recipients: [user2], sender_id: user1.id)
message5 = Message.create(user: user3, conversation: conversation3, body: "test message", recipients: [user3], sender_id: user3.id)
